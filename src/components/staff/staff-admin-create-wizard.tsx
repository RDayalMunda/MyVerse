...
import { createStaffUserApi } from '@/api/users.api';
...
export function StaffAdminCreateWizard() {
  ...
  function canProceed(): boolean {
    switch (step) {
      ...
      case 3:
        return validateStaffProfileBody(profile) === null;
      case 4:
        return true;
      default:
        return false;
  ...
  async function handleNext() {
    ...
    try {
      await createStaffUserApi({
        ...
        staffProfile: {
          ...profile,
          stageName: profile.stageName?.trim() || undefined,
      ...
      <View style={[styles.footer, { borderTopColor: colors.border }]}>
        ...
        >
          {isLoading ? (
            ...
            <Text style={styles.nextText}>{step === 4 ? 'Create' : 'Next'}</Text>
          )}
        </Pressable>
      </View>
    </View>
